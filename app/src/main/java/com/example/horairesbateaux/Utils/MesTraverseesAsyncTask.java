...
public class MesTraverseesAsyncTask extends android.os.AsyncTask<String, Void, String> {
    ...
    public MesTraverseesAsyncTask(Listeners callback){
    ...
    protected String doInBackground(String... url) {
        ...
        return MesTraverseesHttpURLConnection.startHttpRequest(url[0], url[1], url[2], url[3]);
    }
}