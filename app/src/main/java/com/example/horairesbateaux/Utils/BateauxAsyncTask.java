...
public class BateauxAsyncTask extends android.os.AsyncTask<String, Void, String> {
    ...
    public BateauxAsyncTask(Listeners callback){
    ...
    protected String doInBackground(String... url) {
        ...
        return BateauxHttpURLConnection.startHttpRequest(url[0], url[1], url[2], url[3], url[4], url[5], url[6], url[7]);
    }
}